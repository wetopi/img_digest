...
exports.createListImages = function(imgName, callback) {
  ...
  // obtain an image object:
  lwip.open(__dirname + '/../img_resources/shadow_v3.png', function(err, imageShadow) {

    if (err) {
      console.log('err: opening shadow png', err);
      ...
      lwip.open(config.in_path + '/' + imgName, function (err, image) {
        ...
        if (err) {
          console.log('err: opening image:' + imgName, err);
